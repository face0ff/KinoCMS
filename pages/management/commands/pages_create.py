...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        #     BannerBackground.objects.create(id=1, color=fake.hex_color(), imageBackground='start_script/back/bg.jpg',
        #                                     background=True)
        ...
        #         b.url = url
        #         b.promo = True
        #         b.image = 'start_script/banners/' + str(index + 1) + '.jpg'
        ...
        #                                     main_image='start_script/templatePage/empty-photo.png',
        ...
        #                             logo='start_script/templatePage/empty-photo.png',
        #                             seo=Seo.objects.create(seo_title='test', seo_description='test',
        #                                                    seo_keywords='test', seo_url='http://test.ua'))
        ...
        #                           condition='Звездный',
        #                           logo='start_script/templatePage/empty-photo.png',
        #                           banner_up_image='start_script/templatePage/empty-photo.png',
        #                           seo=Seo.objects.create(seo_title='test', seo_description='test',
        #                                                  seo_keywords='test', seo_url='http://test.ua'),
        #                           gallery=Gallery.objects.create())
        #
        ...
        #                             scheme='start_script/templatePage/empty-photo.png',
        #                             banner_up_image='start_script/templatePage/empty-photo.png', cinema=i,
        #                             seo=Seo.objects.create(seo_title='test', seo_description='test',
        #                                                    seo_keywords='test', seo_url='http://test.ua'),
        #                             gallery=Gallery.objects.create())
        ...
        #                             main_image='start_script/films/'+str(films.index(i)+1)+'.jpg',
        ...
        #     Mail.objects.create(HtmlTemplate='start_script/email/mail_test.html')
        ...
        #         news_promo.main_image = 'start_script/news_promo/'+str(index + 1)+'.jpg'
